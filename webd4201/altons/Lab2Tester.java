	...
	public static void main(String[] args) {
		...
		try{
			...
			try{
				...
				System.out.println("\nAttempt to retrieve the student record for Scott Alton (Id: " + possibleId + ")");

				try // now, try to find Scott Alton's student record
				{
					possibleId = 100762638L;
					mainStudent = Student.retrieve(possibleId);
					System.out.println("Student record with id " + possibleId + " retrieved from the database.\n");
					mainStudent.dump();


					System.out.println("TESTING Student.authenticate method.");
					Student.authenticate(100111111, "password");
				}
				catch(NotFoundException e)
				{
					System.out.println("Login failed. Please ensure you are providing valid credentials.\n");
				}
